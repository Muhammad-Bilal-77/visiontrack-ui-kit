      ...
      <div className="space-y-6">
        ...
        <Card className="p-6">
          <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
            <form onSubmit={handleSearchSubmit} className="relative max-w-md w-full md:flex-1">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
              <Input placeholder="Search employees..." className="pl-10" value={search} onChange={handleSearchChange} />
            </form>
            <Button variant="outline" size="sm" onClick={() => loadEmployees()} disabled={loading} className="gap-2 w-full md:w-auto">
