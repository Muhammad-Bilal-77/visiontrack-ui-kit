...
const API_URL = "https://premier-paula-evolvoria-acf84abc.koyeb.app";
    ...
    try {
      ...
      if (mode === "login") {
        ...
        if (response.ok) {
          ...
          try {
            const roleResponse = await fetch("https://premier-paula-evolvoria-acf84abc.koyeb.app/core/api/user-role/", {
              method: "GET",
              headers: {
