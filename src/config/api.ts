...
const API_BASE_URL = import.meta.env.VITE_DJANGO_API_URL || 'https://premier-paula-evolvoria-acf84abc.koyeb.app/api';
const API_BASE_URL1 = import.meta.env.VITE_DJANGO_API_URL || 'https://premier-paula-evolvoria-acf84abc.koyeb.app/core/api';
const API_BASE_URL2 = import.meta.env.VITE_DJANGO_API_URL || 'https://premier-paula-evolvoria-acf84abc.koyeb.app/';
